...
# we wrap the creation of store and employee records in a transaction. All recoreds are saved together
ActiveRecord::Base.transaction do
  ...
  @store2.employees.create(first_name: 'Emma', last_name: 'Varan', hourly_rate: 90)
  @store3.employees.create(first_name: 'Katya', last_name: 'Shilin', hourly_rate: 130)
end
